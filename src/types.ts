...
export type InterferenceGridsSettings = SharedSettings & {
  mode: "interference-grids";
} & InterferenceGridsParams;
export type FlowRibbonsSettings = SharedSettings & { mode: "flow-ribbons" } & FlowRibbonsParams;
export type RadiantBurstsSettings = SharedSettings & {
  mode: "radiant-bursts";
} & RadiantBurstsParams;
...
export type LightningBoltsSettings = SharedSettings & {
  mode: "lightning-bolts";
} & LightningBoltsParams;
export type VoronoiEdgesSettings = SharedSettings & { mode: "voronoi-edges" } & VoronoiEdgesParams;
export type WaveCollisionSettings = SharedSettings & {
  mode: "wave-collision";
} & WaveCollisionParams;
export type CrosshatchSettings = SharedSettings & { mode: "crosshatch" } & CrosshatchParams;
export type PendulumTracesSettings = SharedSettings & {
  mode: "pendulum-traces";
} & PendulumTracesParams;
